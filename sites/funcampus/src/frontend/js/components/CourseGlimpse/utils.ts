...
// that is enough for the current use case of the FUN Campus website and that allows
// to fix a regression introduced by the upgrade to Richie 2.23.0.
// This should be removed once the FUN Campus website is upgraded to the next Richie version.
