...
const messages = defineMessages({
  ...
  organizationCountLabel: {
    defaultMessage: 'Produced by {organizationCount, number} partners',
    description: 'Organization title for multiple organizations',
    id: 'components.CourseGlimpse.organizationCountLabel',
  },
  codeIconAlt: {
