...
// that is enough for the current use case of the Ademe website and that allows
// to fix a regression introduced by the upgrade to Richie 2.23.0.
// This should be removed once the Ademe website is upgraded to the next Richie version.
